...
export default async function handler(
  ...
  try {
    ...
    const prompt = `The following are the possible chart types supported by the code provided: area, bar, line, composed, scatter, pie, radar, radialBar, treemap, and funnel. \nGiven the user input: ${inputData}, identify the chart type the user wants to display. \nReturn just one word`;
